...
def data_reader( list_IDs, 
    ...
    np.save('/home/tza/STEAD/tza/y_EQlabelD_'+lable, y1)
    np.save('/home/tza/STEAD/tza/y_EQlabelP_'+lable, y2)
    np.save('/home/tza/STEAD/tza/y_EQlabelS_'+lable, y3)
    return X, y1, y2, y3
...
class cred2():
    ...
    def __call__(self, inp):
        ...
        norm_layerP, weightdP = SeqSelfAttention(return_attention=True,attention_width= 3,name='attentionP')(PLSTM)
        ...
        norm_layerS, weightdS = SeqSelfAttention(return_attention=True,attention_width= 3,name='attentionS')(SLSTM)
